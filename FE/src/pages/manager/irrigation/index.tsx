    ...
    <ManagerLayout>
      <div className="px-4 sm:px-6 lg:px-8">
        <div className="space-y-8">
          {/* Header */}
          <div>
            <h1 className="text-3xl font-bold text-gray-900">Smart Irrigation Management</h1>
            <p className="text-gray-600 mt-2">
              Manage your automated irrigation system with intelligent scheduling and device control.
            </p>
          </div>
          ...
          <Tabs value={selectedTab} onValueChange={handleTabChange} className="space-y-6">
            <TabsList className="grid w-full grid-cols-3 bg-white shadow-sm border border-gray-200">
              <TabsTrigger value="calendar" className="flex items-center gap-2 data-[state=active]:bg-green-50 data-[state=active]:text-green-700">
                <Calendar className="h-4 w-4" />
                <span className="hidden sm:inline">Schedule Calendar</span>
              </TabsTrigger>
              <TabsTrigger value="rules" className="flex items-center gap-2 data-[state=active]:bg-green-50 data-[state=active]:text-green-700">
                <Brain className="h-4 w-4" />
                <span className="hidden sm:inline">Automation Rules</span>
              </TabsTrigger>
              <TabsTrigger value="devices" className="flex items-center gap-2 data-[state=active]:bg-green-50 data-[state=active]:text-green-700">
            ...
            <TabsContent value="devices" className="space-y-6">
              <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                <div className="mb-6">
                  <h2 className="text-2xl font-semibold text-gray-900">Device Control Panel</h2>
                  <p className="text-gray-600">Monitor and control your irrigation devices in real-time</p>
                </div>
                <DeviceList />
              </div>
            </TabsContent>
